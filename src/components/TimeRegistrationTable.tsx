      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <SortableTableHeader field="startTime" currentSort={sort} onSort={handleSort} className="w-[100px]">
              <div>Start Time</div>
            </SortableTableHeader>
            <SortableTableHeader field="endTime" currentSort={sort} onSort={handleSort} className="w-[100px]">
              <div>End Time</div>
            </SortableTableHeader>
